 ...
 */
export var KAKAO_AUTH_TYPES;
(function (KAKAO_AUTH_TYPES) {
    KAKAO_AUTH_TYPES[KAKAO_AUTH_TYPES["Talk"] = 2] = "Talk";
    KAKAO_AUTH_TYPES[KAKAO_AUTH_TYPES["Story"] = 4] = "Story";
    KAKAO_AUTH_TYPES[KAKAO_AUTH_TYPES["Account"] = 8] = "Account";
})(KAKAO_AUTH_TYPES || (KAKAO_AUTH_TYPES = {}));
 ...
 */
export function login(authTypes, callback) {
    var authTypesWithDefault = authTypes || [];
 ...
 * @returns {Promise<string>}
 */
export function unlink(callback) {
 ...
 * @returns {Promise<ITokenInfo>}
 */
export function updateScopes(scopes, callback) {
