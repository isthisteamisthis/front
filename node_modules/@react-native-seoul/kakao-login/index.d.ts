 ...
 */
export declare enum KAKAO_AUTH_TYPES {
    Talk = 2,
    Story = 4,
    Account = 8
}
 ...
 */
export declare function login(authTypes?: Array<KAKAO_AUTH_TYPES>, callback?: ICallback<ITokenInfo>): Promise<ITokenInfo>;
/**
 * logout
 ...
 * @returns {Promise<string>}
 */
export declare function unlink(callback?: ICallback<string>): Promise<string>;
/**
 * updateScopes
 ...
 * @returns {Promise<ITokenInfo>}
 */
export declare function updateScopes(scopes: Array<string>, callback?: ICallback<ITokenInfo>): Promise<ITokenInfo>;
export declare function getTokens(callback?: ICallback<{
    accessToken: string;
    refreshToken: string;
}>): Promise<{
    accessToken: string;
